...
intellisense.annotate(jQuery.fn, {
  ...
  'id': function() {
    /// <signature>
    ///   <summary>Selects a single element with the given tokenId attribute.</summary>
    ///   <param name="tokenId" type="String">An ID to search for, specified via the tokenId attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
